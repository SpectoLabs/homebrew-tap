class Hoverfly < Formula
  ...
  url "https://github.com/SpectoLabs/hoverfly/archive/v0.11.5.tar.gz"
  version "0.11.5"
  sha256 "7931175a9ea5fca68d3e0dad255a4100ebb9ae6859f260e1f542a897c6e4e14b"
  ...
  def install
	...
	system "make", "build", "GIT_TAG_NAME=v0.11.5"
