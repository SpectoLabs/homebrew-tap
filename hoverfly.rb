class Hoverfly < Formula
  ...
  url "https://github.com/SpectoLabs/hoverfly/archive/v0.12.3.tar.gz"
  version "0.12.3"
  sha256 "3622f1266c0b9dea9abe14482696946b19bfe05ab41bdae70412921c5e3be8ef"
  ...
  def install
	...
	system "make", "build", "GIT_TAG_NAME=v0.12.3"
