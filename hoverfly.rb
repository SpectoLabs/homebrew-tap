class Hoverfly < Formula
  ...
  url "https://github.com/SpectoLabs/hoverfly/archive/v1.1.1.tar.gz"
  version "1.1.1"
  sha256 "7890c1f4595d4257bf478ac334ac5658ce063cfd49c1614f6149da379cb0e9eb"
  ...
  def install
	...
	system "make", "build", "GIT_TAG_NAME=v1.1.1"
